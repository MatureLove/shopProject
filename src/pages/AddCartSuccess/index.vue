      ...
      <div class="goods">
        <div class="left-good">
          ...
          <div class="right-info">
            ...
            <p class="attr">
              <span v-for="(spuSaleAttr, index) in  spuSaleAttrList" :key="index">
                {{ spuSaleAttr.saleAttrName }}
                :
                <span v-for="(spuSaleAttrValue, index) in spuSaleAttr.spuSaleAttrValueList" :key="index"
                  v-if="spuSaleAttrValue.isChecked == 1">
